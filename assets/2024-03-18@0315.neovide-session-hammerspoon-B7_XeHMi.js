import{j as e}from"./jsx-runtime-B85TLFS3.js";import"./entry-DW7Hy8AH.js";const a="Neovide Session Management with Hammerspoon",r="neovide-session-hammerspoon",d="2024-03-18T07:15:29.550Z",c=[],h="Global MacOS keybindings for managaing neovide sessions are possible by using neovim's clien-server architecture.",l="",m="112121306783074280";function i(o){const n={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{children:"Neovide Session Management with hammerspoon"}),`
...
`,e.jsx(n.p,{children:"TODO: Fix PATH in neovim server because it doens't have any PATH..."})]})}function p(o={}){const{wrapper:n}=o.components||{};return n?e.jsx(n,{...o,children:e.jsx(i,{...o})}):i(o)}export{d as date,p as default,l as image,m as mastodonPostId,r as slug,h as summary,c as tags,a as title};
