            ...
            <>
                ...
                {mailtoParam && (
                    <div>
                        ...
                        <p>
                            The link should have opened automatically. If it
                            didn't, it might because a popup blocker blocked it.
                        ...
                        <button
                            ...
                            onClick={() => {
                                const mailto = atob(
                                    decodeURIComponent(mailtoParam)
                                );
                                window.location.href = mailto;
                                openedMailto.current = true;
                            }}
                ...
                <p>
                    Whether you're rallying support, sharing a must-see email
                    template, or just making it easier for friends to reach out,
                    our tool removes the barriers, making your call to action as
                    simple as clicking a link. No more copying and pasting email
                    addresses - just direct, effective communication. 🎯
                </p>
                ...
                >
                    <li>
                        ...
                        recipient's email, a catchy subject, and the message
                        body you want to share. This could be anything from a
                        personalized note to a ready-to-go email template. 📝
                    </li>
                    <li>
                        <strong>Generate Your Link:</strong> Hit the 'Create
                        Link' button to transform your email into a shareable,
                        clickable link. We use magic (okay, not really - just
                        some clever base64 and URL encoding) to make your mailto
                        link portable. ✨
                    </li>
                    <li>
                        <strong>Share Far and Wide:</strong> Copy your newly
                        minted link and share it across platforms, even where
                        standard mailto links dare not go. Perfect for
                        amplifying your message on social media, forums, or
                        anywhere you can post a link! 🔗
                    </li>
                </ol>
                ...
                <form>
                    ...
                    >
                        ...
                        <label style={{}}>
                            ...
                            {" - "}
                            <i>
                                This will store the email, subject, and body in
                                your browser's local storage, so if you come
                                back to this page, the fields will be pre-filled
                                with the last values you used.
                            </i>
                        </label>
                        <button
                            style={{
                    ...
                    >
                        ...
                        <p>
                            This is the "standard" mailto link, in the URI
                            format. Note this may not work in all contexts, such
                            as social media posts on platforms that don't
                            support mailto links, such as <code>linktree</code>.
                        </p>
                        {mailto ? (
                            <pre
                                style={{
                            ...
                            >
                                ...
                                <p>
                                    ...
                                    necessary information to generate a mailto
                                    link. After filling out the form, click the
                                    "Generate mailto link" button to generate
                                    the mailto link.
                                </p>
                            </article>
                        )}
                        ...
                        <p>
                            ...
                            <i>linktr.ee</i> that might not directly support
                            links that use the <code>mailto</code> protocol.
                        </p>
                        {portableMailto ? (
                            <pre
                                style={{
                            ...
                            >
                                https://nyanhelsing.github.io/tools.html?mailto=
                                {portableMailto}
                            </pre>
                        ) : (
                            <article
                            ...
                            >
                                ...
                                >
                                    INFO: A "portable" <code>mailto</code> link
                        ...
                        <button
                            ...
                            onClick={(event) => {
                                ...
                                navigator.clipboard.writeText(
                                    `https://nyanhelsing.github.io/tools.html?mailto=${portableMailto}`
                                );
                            }}
                        >
                        ...
                        <p>
                            Clicking this takes you to the mailto directly. Use
                            this to embed the "mailto" link into a website.
                        </p>
                        {mailto ? (
                            <>
                                <h4>Preview:</h4>
                            ...
                            >
                                ...
                                >
                                    INFO: The code for embedding{" "}
                                    <code>mailto</code> link has not yet been
                                    generated
                                </h4>
                                <p>
                                    The form above can be used to provide the
