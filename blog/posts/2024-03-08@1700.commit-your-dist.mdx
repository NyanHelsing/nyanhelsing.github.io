export const slug = "commit-your-dist";
export const title = "Streamlining Deployment with Git Submodules";
export const date = "2024-03-08";
export const isoDate = "2024-03-08T17:00:00.000Z";
export const cover = "connect-push.png"
export const summary = "Leveraging Git submodules in combination with a custom script can significantly simplify your deployment process. This method is not only efficient but also adaptable to various project setups, making it a valuable addition to your development toolkit.";
/*****************************************************************************/
